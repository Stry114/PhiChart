...
player = Player(Matcher(r"charts/领土战争AT"), w=1200, h=900, fps=120)

# 设置副标题
player.name = "Stardust:RAY"
player.level = "IN Lv.?"
...
# 设置摄像机位置，推荐处于中间偏上的位置
player.cmrY = player.height*0.3
player.cmrX = player.width*0.5
player.lineLength = 20000

# 设置键出现的位置，推荐值为3倍屏幕高度
player.boundary = 4 * player.height
# 设置流速，推荐为3倍速
player.speed = 3.4
